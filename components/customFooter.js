...
class CustomFooter extends HTMLElement {
  constructor() {
    ...
    githubLink.setAttribute("class", "footer-contact-icon");
    githubLink.setAttribute("href", "https://github.com/jmcdl");
    ...
    linkedInLink.setAttribute("class", "footer-contact-icon");
    linkedInLink.setAttribute("href", "https://www.linkedin.com/in/james-mcdonell-7bab8049");
    ...
    linkedInSvg.setAttribute("stroke", "currentColor");
    linkedInSvg.setAttribute("fill", "currentColor");
    linkedInSvg.setAttribute("stroke-width", "0");
    linkedInSvg.setAttribute("viewBox", "0 0 448 512");
    linkedInSvg.setAttribute("height", "1em");
    linkedInSvg.setAttribute("width", "1em");
    linkedInSvg.setAttribute("xmlns", "http://www.w3.org/2000/svg");
    const linkedInSvgPath = document.createElementNS("http://www.w3.org/2000/svg","path");
    linkedInSvgPath.setAttribute(
      "d",
    ...
    emailLink.setAttribute("class", "footer-contact-icon");
    emailLink.setAttribute("href", "mailto:jmcdl@protonmail.com");
    ...
    emailSvg.setAttribute("stroke-width", "0");
    emailSvg.setAttribute("viewBox", "0 0 512 512");
    emailSvg.setAttribute("height", "1em");
    emailSvg.setAttribute("width", "1em");
    emailSvg.setAttribute("xmlns", "http://www.w3.org/2000/svg");
    const emailSvgPath = document.createElementNS("http://www.w3.org/2000/svg","path");
    emailSvgPath.setAttribute(
      "d",
    ...
    linkedInSvg.appendChild(linkedInSvgPath);
    // append email link
    iconsContainer.appendChild(emailLink);
    emailLink.appendChild(emailSvg);
    emailSvg.appendChild(emailSvgPath);
